...
const Footer = () => {
  return (
    <div>
      <section className="bg-blue-200 mt-16 py-12 px-6 md:px-16" id="contact">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-blue-800 mb-8">
            Get in Touch
          </h2>

          <div className="grid justify-center items-center md:grid-cols-2 gap-10 ">
            <div className="space-y-6 text-gray-700">
              <div>
                <h3 className="font-semibold text-3xl mb-2 text-blue-600">
                  MCA Department
                </h3>
                <p>
